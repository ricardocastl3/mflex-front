    ...
    <div
      className={`${
        openBanner
          ...
          : ""
      } flex w-full border-b border-slate-200 dark:border-slate-800 md:pr-8 pr-4 md:pl-4 pl-4 md:py-1.5 py-2 justify-between md:bg-white bg-white dark:bg-ausoft-slate-900 items-center md:gap-4 gap-2`}
    >
      <Link
