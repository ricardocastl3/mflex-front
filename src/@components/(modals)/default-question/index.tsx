      ...
      <BaseBox className="md:w-[40vw] w-[90vw] h-fit flex flex-col justify-between">
        ...
        {!modalQuestionData?.isUpdated && (
          <div className="md:py-4 py-6 md:px-6 px-6 w-full flex flex-col items-center gap-2">
            ...
            />
            <h4 className="font-bold text-lg text-yellow-600 text-center dark:text-yellow-400">
              <CTranslateTo
        ...
        {modalQuestionData?.isUpdated && (
          <div className="flex flex-col items-center pb-4">
            <Image
              ...
              alt="AuSoftCoin"
            />
            <h4 className="font-bold pt-3 pb-0.5 text-lg text-yellow-600 text-center dark:text-yellow-400">
              <CTranslateTo
