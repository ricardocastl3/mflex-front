...
export default function CRTCommentInputEdit({
  ...
  return (
    <div className="animate-fade border-b flex flex-col items-start gap-4 border-slate-300 dark:border-slate-800 pb-4 w-full">
      <AuSoftUI.UI.TextField.TextArea
        onChange={(e) => {
          setContent(e.target.value);
        }}
        value={content}
        className="h-[80px] flex-1 w-full border-none bg-slate-200 text-slate-800 dark:bg-slate-800/20 dark:text-white"
      />
