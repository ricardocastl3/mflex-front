...
export default function CRTResInputAnswer({
  callbackClose,
  comment,
}: {
  ...
  return (
    <div
      id={`input-res-${comment.id}`}
      className="border-t border-r-slate-300  animate-fade border-b flex flex-col items-start gap-4 border-slate-300 dark:border-slate-800 py-4"
    >
