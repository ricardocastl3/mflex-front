...
export default function EventCard({ event }: { event: Omit<IEvent, ""> }) {
  return (
    <div className="flex flex-col gap-4 cursor-pointer w-full md:hover:scale-[1.03] scale-100 transition-all">
      <BaseBox
        style={{
          height: "400px",
